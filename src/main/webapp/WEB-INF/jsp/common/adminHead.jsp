        ...
        <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="/admin/nileperch/membersForm">Add Members</a>
                    </li>
                    <li>
                        <a href="/admin/nileperch/membersList">View Members</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Vehicles<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="/admin/nileperch/membersForm">Add Vehicle</a>
                    </li>
                    <li>
                        <a href="/admin/nileperch/membersList">View Vehicles</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                <a href="/admin/nileperch/contribution"><i class="fa fa-files-o"></i> <span>Contribution</span></a>
            </li>

            <li>
                <a href="/admin/nileperch/expenditure"><i class="fa fa-files-o"></i> <span>Expenditure</span></a>
            </li>
